...
namespace SineVita.Muguet.Nelumbo {
    public class SutraContext {
        ...
        public bool Evaluate(IReadOnlyPitchInterval interval, FormalIntervalClassification intervalClass) {
            return _intervalEvaluation.ContainsKey(intervalClass) 
                    ? _intervalEvaluation[intervalClass](PitchInterval.Abs(interval.ToPitchInterval()))
                    : false;
        }
